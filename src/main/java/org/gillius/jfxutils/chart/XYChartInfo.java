...
public class XYChartInfo {
    ...
    public Rectangle2D getDataCoordinates(double minX, double minY, double maxX, double maxY) {
        ...
        // The "low" Y data value is actually at the maxY graphical location as
        // Y graphical axis gets
    ...
    public Rectangle2D getPlotArea() {
        ...
        // If the direct method to get the width (which is based on its Node
        // dimensions) is not found to
        // be appropriate, an alternative method is commented.
        // double width = xAxis.getDisplayPosition( xAxis.toRealValue(
        // xAxis.getUpperBound() ) );
        double width = xAxis.getWidth();
        // double height = yAxis.getDisplayPosition( yAxis.toRealValue(
        // yAxis.getLowerBound() ) );
