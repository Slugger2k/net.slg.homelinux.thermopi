...
/**
 * EventHandlerManager manages a set of event handler registrations on a target,
 * for which all of those registrations can be activated or deactivated in a
 * single step. It also keeps the handlers from being added more than once.
 *
...
public class EventHandlerManager {
    ...
    /**
     * Adds an event registration, optionally adding it to the target
     * immediately.
     */
