...
public class JFXUtil {
     ...
     *
     * @param descendant
     *            a Node that is a descendant (direct or indirectly) of the
     *            ancestor
     * @param ancestor
    ...
    public static void replaceComponent(Node original, Node replacement) {
        ...
        if (parent instanceof BorderPane) {
            ...
            // Hope that preserving the properties and position in the list is
            // sufficient
     ...
     * @param override
     *            if true, w,h is the region's "100%" size even if the region
     *            has an explicit preferred width and height set.
     *
    ...
    public static StackPane createScalePane(Region region, double w, double h, boolean override) {
        ...
        // Bind the scene's width and height to the scaling parameters on the
        // group
